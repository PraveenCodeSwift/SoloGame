...
//  HitTheTree
//
//  Created by Praveen on 26.04.18.
...
class HitTreeViewController: UIViewController {
   ...
   func setupScene(){
        ...
        tapRecognizer.addTarget(self, action: #selector(HitTreeViewController.sceneViewTapped(recognizer:)))
...
extension HitTreeViewController : SCNSceneRendererDelegate {
...
extension HitTreeViewController : SCNPhysicsContactDelegate {
